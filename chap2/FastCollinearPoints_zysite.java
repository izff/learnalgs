 ...
 * @date 2017.3.19
 */
public class FastCollinearPoints_zysite
{
     ...
     */
    public FastCollinearPoints_zysite(Point[] points)     
    {
    ...
    public static void main(String[] args)
    {
        ...
        FastCollinearPoints_zysite collinear = new FastCollinearPoints_zysite(points);
